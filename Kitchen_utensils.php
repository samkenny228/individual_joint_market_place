...
$select_pn = mysqli_query($conn, "SELECT * FROM reg_product WHERE p_category = 'Kitchen_utensils' AND status = '' ORDER by rand() DESC");
...
<a href="product/order_page.php?buid=<?= $brand_unique_id ?>&pcn=Kitchen_utensils" class="link_p" target="_blank">Order now</a>
</div>
