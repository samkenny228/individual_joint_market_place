...
if(isset($_POST['btn_not_available'])){
    ...
    $update_p_status = mysqli_query($conn, "UPDATE reg_product SET status = '' WHERE p_unique_id = '$p_unique_id'");
    if($update_p_status){
        echo "<script>alert('Product is now available!')</script>"; ?>
