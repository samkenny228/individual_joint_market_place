...
<button type="submit" name="btn_p_img" class="btn_p_img"><img src="../reg_img/<?=$p_image;?>" class="orp_image"></button><br>
...
<button type="submit" name="btn_p_img" class="btn_p_img"><img src="../reg_img/<?=$p_image;?>" class="p_image"></button><br>
<div class="div_p_details">
<span class="span_p_details">Price: </span>
<?php if($currency == 'naira'){
echo '&#8358;';
