...
$select_pn = mysqli_query($conn, "SELECT * FROM reg_product WHERE p_category = 'Furniture_work' AND status = '' ORDER by rand() DESC");
...
<a href="service/order_page.php?buid=<?= $brand_unique_id ?>&pcn=Furniture_work" class="link_p" target="_blank">Order now</a>
</div>
