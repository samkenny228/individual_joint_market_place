...
while($fetch_user_order_cart = mysqli_fetch_assoc($select_user_order_cart)){ 
    ...
    $order_items[] ='<img src="../reg_img/'.$p_image.'" class="or_image" alt="service order"><br> PRODUCT: '.$p_name.'<br> PRICE: &#8358;'.number_format($reg_p_price).''.'<br> DICRIPTION: '.$p_discription.''.'<br><hr>';
?>
<?php
}
