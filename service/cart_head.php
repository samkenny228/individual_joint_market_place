...
<h5 class="h1_heading_order_page" style="background-color: <?= $background_color ?>;">
    ...
    <form method="post" action="" class="form_cart">
       <span class="span_icon">
            <a href="livechat.php?buid=<?=$brand_unique_id;?>&pcn=<?=$product_category_name;?>" class="link_drop_p">
            <i class="bi bi-chat-square-text-fill"></i>
            <span class="new_chat"></span>
            </a>
            <a style="margin-left: 10px;"  href="check_out_page.php?buid=<?=$brand_unique_id;?>&pcn=<?=$product_category_name;?>" class="link_cart_icon">
