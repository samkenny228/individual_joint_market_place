...
if(isset($_POST['reg_brand_name'])){
    ...
    $save_brand_detailes =  mysqli_query($conn, "insert into brand_register(brand_name, email, password, state, Other_service, bank_account_name, bank_name, bank_account_number, phone_number, currency, premium_expire)
