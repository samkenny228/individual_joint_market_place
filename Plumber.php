...
$select_pn = mysqli_query($conn, "SELECT * FROM reg_product WHERE p_category = 'Plumber' AND status = '' ORDER by rand() DESC");
...
<a href="service/order_page.php?buid=<?= $brand_unique_id ?>&pcn=Plumber" class="link_p" target="_blank">Order now</a>
</div>
