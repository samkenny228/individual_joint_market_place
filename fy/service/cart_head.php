...
if(isset($_GET['buid'])){
    ...
    if(mysqli_num_rows($select_brand_name) < 1){
        ...
        $select_user_order_cart = mysqli_query($conn, "SELECT * FROM cart WHERE user_order_id = '$user_order_id'");
...
$select_user_order_cart = mysqli_query($conn, "SELECT * FROM cart WHERE user_order_id = '$user_order_id' ORDER by 1 DESC");
$num_user_order_cart = mysqli_num_rows($select_user_order_cart);
if($num_user_order_cart < 1){
...
<head>
    ...
    <script src="jsfile/new_chat_buyer.js"></script>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.3.0/font/bootstrap-icons.css">
    </head>
<body style="background-color: <?= $background_color ?>;">
<h5 class="h1_heading_order_page" style="background-color: <?= $background_color ?>;">
    ...
    <form method="post" action="" class="form_cart">
       ...
       <a href="livechat.php?buid=<?=$brand_unique_id;?>&pcn=<?=$product_category_name;?>" class="link_drop_p" style="margin-right: 10px;">
            <i class="bi bi-chat-square-text-fill"></i>
                    <span class="new_chat"></span>
            </a>
            <a href="check_out_page.php?buid=<?=$brand_unique_id;?>&pcn=<?=$product_category_name;?>" class="link_cart_icon">
