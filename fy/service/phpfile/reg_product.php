...
if(isset($_POST['reg_p_name'])){
    ...
    $save_reg_product = mysqli_query($conn, "INSERT INTO reg_product(p_name, p_discription, p_category, p_image, brand_unique_id, reg_p_price)
                        VALUE('$reg_p_name', '$reg_p_discription', '$reg_p_category', '$new_reg_p_img_name', '$brand_unique_id', '$reg_p_price')");
    if($save_reg_product){
