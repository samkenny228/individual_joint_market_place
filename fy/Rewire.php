...
$select_pn = mysqli_query($conn, "SELECT * FROM reg_product WHERE p_category = 'Rewire' AND status = '' AND member = 'FY_001_MEM' ORDER by rand() DESC");
...
<a href="product/order_page.php?buid=<?= $brand_unique_id ?>&pcn=Rewire" class="link_p" target="_blank">Order now</a>
</div>
</div>
