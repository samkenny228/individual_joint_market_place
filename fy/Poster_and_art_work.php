...
$select_pn = mysqli_query($conn, "SELECT * FROM reg_product WHERE p_category = 'Poster_and_art_work' AND status = '' AND member = 'FY_001_MEM' ORDER by rand() DESC");
...
<a href="product/order_page.php?buid=<?= $brand_unique_id ?>&pcn=Poster_and_art_work" class="link_p" target="_blank">Order now</a>
</div>
</div>
