...
$select_pn = mysqli_query($conn, "SELECT * FROM reg_product WHERE p_category = 'Dry_cleaner' AND status = '' AND member = 'FY_001_MEM' ORDER by rand() DESC");
...
<a href="product/order_page.php?buid=<?= $brand_unique_id ?>&pcn=Dry_cleaner" class="link_p" target="_blank">Order now</a>
</div>
</div>
